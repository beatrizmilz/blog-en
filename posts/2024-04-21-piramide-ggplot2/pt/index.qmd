...
```{r}
dplyr::count(dados_brutos, `Município`) |> 
  knitr::kable()
```
...
3) Aparecem valores negativos no eixo X. Mas não faz sentido população negativa, certo?

2) Vamos deixar mais bonito? Colocar os textos, mudar o tema, etc...
