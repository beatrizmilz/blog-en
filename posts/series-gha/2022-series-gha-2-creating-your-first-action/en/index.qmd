...
The job describes what the computer should do! In this example, we will install R on a Ubuntu machine, run our script and then save the results in the repository.
...
YEY! Now that we created the files needed, we can first experiment with the `workflow_dispatch` button. I made a quick GIF on how to trigger a GHA with the button:
