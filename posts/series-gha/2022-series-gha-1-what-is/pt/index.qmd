...
Oi!
Este é o primeiro post da série "GitHub Actions". Esta série de posts é um material complementar para minha palestra relâmpago na [RStudio Conference - rstudio::conf 2022](https://www.rstudio.com/conference/).
...
Não encontrei exemplos de uso do GHA com scripts simples (sem a estrutura do pacote) no [repositório r-lib/actions](https://github.com/r-lib/actions/blob/v2-branch/examples/ README.md).
...
O fluxo de trabalho inicia ao pressionar um botão no GitHub (o evento). Ele instala o R e imprime a mensagem "Hello R World!" no console (o trabalho).
