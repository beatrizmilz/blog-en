...
1. First, Sign up or Log in on [Netlify](https://www.netlify.com/). I recommend signing in using your GitHub account.
...
The [quarto documentation](https://quarto.org/docs/output-formats/html-basics.html#commenting) explains how to add comments with three different options: [Hypothes.is](https://web.hypothes.is/), [Utterances](https://utteranc.es/) and [Giscus](https://giscus.app/). You can use whatever suits you best.

I chose to use [Giscus](https://giscus.app/) and here I'll tell you how to set it up!

1. Your repository needs to be public on GitHub. The default is to be public, it will only be private if you changed it (you can change it back on your repository settings on GitHub).
...
- Write blog posts! Your blog posts are stored in the `posts/` directory. Each post has to have a folder, and inside this folder you need a `index.qmd` file. But follow along the template that is already there and you will be good to go. Also, I recommend checking the awesome options described on the [Quarto documentation](https://quarto.org/docs/output-formats/html-basics.html).
...
To me, a person who is used to using blogdown, Quarto is an awesome tool, has simple code and is full of great documentation. I also think that the experience is similar to using [Distill](https://rstudio.github.io/distill/).
