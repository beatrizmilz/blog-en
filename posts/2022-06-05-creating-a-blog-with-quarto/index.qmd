...
My [blog in Portuguese](https://beatrizmilz.com/blog/) will continue to exist, and I will continue to post there (in Portuguese). In this blog, I'll add content in English.
...
First of all: the Quarto team made a huge effort writing [the documentation](https://quarto.org/docs/websites/website-blog.html). I suggest that you open it in another tab, and use the Search button in the top-right of the docs page (believe me, the search feature used in Quarto is awesome!).
...
- This blog! Check other pages and see what you would like to have in your personal page. The code used to create this blog is [available on GitHub](https://github.com/beatrizmilz/blog-en).
...
Next, we will create a URL to put the blog online. This step is called **deploy**, and we will use a service called [Netlify](https://www.netlify.com/) for this purpose.

1. First, Sign up or Log in on [Netlify](https://www.netlify.com/). I recommend to sign in using your GitHub account.
...
You can change the colors, fonts and more of the style of your blog by changing the **theme** in the file `_quarto.yml`. You can create your own theme or choose between the options on the [Quarto documentation](https://quarto.org/docs/output-formats/html-themes.html#overview). 
...
The [quarto documentation](https://quarto.org/docs/output-formats/html-basics.html#commenting) explains how to add comments with three diferent options: [Hypothes.is](https://web.hypothes.is/), [Utterances](https://utteranc.es/) and [Giscus](https://giscus.app/). You can use whatever suits you best.
...
- Write blog posts! Your blogposts are stored in the `posts/` directory. Each post has to have a folder, and inside this folder you need a `index.qmd` file. But follow along the template that is already there and you will be good to go. Also, I recommend to check the awesome options described on the [Quarto documentation](https://quarto.org/docs/output-formats/html-basics.html).

- If you are out of ideas about what to write, my advice is to write something that you already know, want to learn, or something that you like a lot. I enjoy reading blog posts that people write about topics they are interested in!
...
My suggestion to you is: Write a tweet! You can use the [`#rstats` hashtag](https://twitter.com/search?q=%23RStats&src=typeahead_click) if the content of your blog is about R and you can cite [@quarto_pub](https://twitter.com/quarto_pub).
...
To me, a person who is used to use blogdown, Quarto is an awesome tool, has simple code and is full of great documentation.
