...
[Tidyverse Developer Day](https://github.com/tidyverse/dev-day-2019) (tidy-dev-day) is a day-long event where attendees learn more about how to contribute to [tidyverse](https://www.tidyverse.org/).
The first edition was at [rstudio::conf2019](https://resources.rstudio.com/tidyverse/tidyverse-developer-day-2019). 

This was the second edition of tidy-dev-day and was a part of the  [useR!2019 conference](https://user2019.r-project.org/), which took place in Toulouse, France.
The event happened the day before the start of the conference, bringing together several people who participated in it.

Something to note is that the [useR!2019](https://user2019.r-project.org/) organization offered diversity scholarships, providing financial assistance to members of underrepresented groups in the R to participate in the conference.
The diversity scholarships were fundamental for the participation of several people from different parts of the world, including the authors of this post (Bea and Angelica).
...
By the time of the event, I have not developed a package yet. So when I arrived at the event, I didn't knew how packages were structured.
In the [issue I chose](https://github.com/tidyverse/dplyr/issues/3698)to work on, the goal was to improve an error message from the function [`dplyr::filter()`](https://dplyr.tidyverse.org/), so that the message would conform to the [tidyverse style guide](https://style.tidyverse.org/).
![](https://i.imgur.com/VYgvY7k.jpg)

**Caption:** Photo of the issue I was working on and the unique coin we received that day. Photo by [\@Bea_Milz](https://twitter.com/Bea_Milz).
...
[Ildi Czeller](https://ildiczeller.com/) showed me what directory the functions were in (by the way, it's in `/R`), and then I was able to find the file I needed to change and what part of the code was corresponding to the `filter()` function.
That was the first time I heard about [tests](https://testthat.r-lib.org/), and I had to change the test referring to the error message I was working on.

After making the changes I felt were necessary, I made a [pull request](https://github.com/tidyverse/dplyr/pull/4477).
Hadley replied that someone else was also working on this issue and indicated where the person was sitting.
So I went there and asked [Colin](https://github.com/rundel) (who was working on this same issue) if we could work together.

He was super welcoming!
He explained how he was developing the improvement, and I also showed him what I had done.
Hadley asked to change some tests, and we worked on it together (in this case, I was mostly learning and asking Colin, because tests were new to me).
...
At the event, several people facilitated the activity.
They helped the participants with activities like how to do a fork on GitHub, work on the issue in R, make a pull request, and so on.
I had the help of [Ildi Czeller](https://ildiczeller.com/), who was one of the helpers and helped me at every step, giving tips from git settings to teaching shortcuts in Rstudio that made life easier (they are documented [here](https://support.rstudio.com/hc/en-us/articles/200711853-Keyboard-Shortcuts)).
...
At one point, I was able to talk to [Hadley](http://hadley.nz/) and ask questions about an issue I was working on.
Understanding better ggplot2 with one of the authors of the package was an incredible learning experience.
...
It was an excellent opportunity to meet new people too!
And to meet many people from the community that we admire.

![](https://i.imgur.com/oWtQFxi.jpg)

**Caption:** Angelica and Bea showing the issues that they were working on tidy-dev-day. Photo by [AngCustodio](https://twitter.com/angcustodio).
