...
Uma forma de saber quais são as nossas variáveis de ambiente é usando a função `Sys.getenv()` sem argumentos. Atenção, várias variáveis de configuração irão aparecer nesse output e não recomendo alterá-las.
