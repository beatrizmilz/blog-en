...
Hi! Here is the first translated post on my blog: I wrote this text in Portuguese in 2021.</div>
...
Another critical point is that the exams happened with the shared screen, and I could use Google search. But the exam had a time limit, so it was essential to pay attention to the time spent searching!
...
I don't have much to say about this step; practice and use it as much as possible in your daily life and work, so you'll have more experience and solve problems faster during the test.

## Approval!

After passing the exams, I received an email with a certificate, and they asked me for some information to add to the list of certified trainers.
...
<center>
<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Muito feliz em dizer que sou uma instrutora de <a href="https://twitter.com/hashtag/tidyverse?src=hash&amp;ref_src=twsrc%5Etfw">#tidyverse</a> certificada pela RStudio! 🎉<br><br>I&#39;m so happy to tell that I&#39;m a certified tidyverse Instructor!<br><br>Thanks <a href="https://twitter.com/gvwilson?ref_src=twsrc%5Etfw">@gvwilson</a> and @RStudioEDU for this great opportunity. <a href="https://t.co/NL4SeT4mxN">https://t.co/NL4SeT4mxN</a></p>&mdash; Beatriz Milz (@BeaMilz) <a href="https://twitter.com/BeaMilz/status/1312129792771125255?ref_src=twsrc%5Etfw">October 2, 2020</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>

</center>

## What about the language?

In my opinion, it is valuable to have some experience with English, because the training is live and in English.
...
Daniel's participation made it possible for me to present the teaching demo entirely in Portuguese and be able to answer the test questions in Portuguese.
...
It was essential for me to feel more relaxed during the test, as I would have to worry less about the language and more about the content of the tests itself.
...
- [Yanina Saibene](https://twitter.com/yabellini), for helping me with the following steps!
...
- Posts on blogs by people who have done the training:
    ...
    -   [Silvia Canelón](https://silvia.rbind.io/2020-10-07-rstudio-instructor-certification-tidyverse/) - I **very** recommend reading it. It features an extensive list of useful links too!
...
- [The Carpentries Instructor Training: Suggested Rubric for Teaching Demonstrations](https://carpentries.github.io/instructor-training/demos_rubric/) - This page from The Carpentries presents some examples of points to note for in-class feedback, with positive and negative examples about content and presentation.
     It's cool to practice offering the test class and try to do some reflection and self-feedback, using these points as a starting point!
